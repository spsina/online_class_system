                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-data-table :header-props="{
                                ...
                                }" :headers="quiz_data_headers" :items="theClass.quizzes" :search="search" :footer-props="{
            ...
            <v-col cols="12">
                <v-card>
                    ...
                    <v-card-text>
                        <v-data-table :header-props="{
                                    'sort-by-text':'مرتب سازی بر اساس',
                                }" :search="std_search" :headers="student_data_headers" :items="theClass.students" :footer-props="{
                                    showFirstLastPage: true,
